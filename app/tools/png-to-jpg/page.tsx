      ...
      <section className="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-14">
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
            Convert PNG images to JPG directly in your browser. Your images
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Your image will keep its original dimensions. Transparent
                    areas will use a white background in the JPG.
                  </p>
                  ...
                  {convertedUrl && (
                    <div className="mt-6 rounded-2xl border border-emerald-100 bg-emerald-50 p-5">
                      ...
                      <a
                        href={convertedUrl}
                        download="quicktools-converted.jpg"
        ...
        <div className="mx-auto mt-12 max-w-3xl rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <h2 className="text-xl font-bold">Free PNG to JPG conversion</h2>
          ...
          <p className="mt-3 leading-7 text-slate-600">
            The converted JPG keeps the original image dimensions. Transparent
            areas are rendered with a white background.
          </p>
        </div>
      </section>
