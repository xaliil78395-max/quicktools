    ...
    <main className="min-h-screen bg-slate-50 text-slate-950">
        ...
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-base leading-7 text-slate-600 sm:text-lg">
            Convert JPG and JPEG images to PNG directly in your browser.
              ...
              <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div>
                  ...
                  <p className="mt-2 text-sm leading-6 text-slate-500">
                    Your image will keep its original dimensions while being
                    converted to PNG.
                  </p>
                  ...
                  {convertedUrl && (
                    <div className="mt-6 rounded-2xl border border-emerald-100 bg-emerald-50 p-5">
                      <div className="flex items-center justify-between gap-4">
                        <div>
                          ...
                          <p className="mt-1 text-sm text-emerald-700">
                            PNG · {image.width} × {image.height}px ·{" "}
                      ...
                      <a
                        href={convertedUrl}
                        download="quicktools-converted.png"
        ...
        <div className="mx-auto mt-12 max-w-3xl rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
          <h2 className="text-xl font-bold">Free JPG to PNG conversion</h2>

          <p className="mt-3 leading-7 text-slate-600">
            QuickTools converts your JPG image directly on your device. Your
            original image does not need to be uploaded to a remote server.
          </p>

          <p className="mt-3 leading-7 text-slate-600">
            The converted PNG keeps the original image dimensions and is ready
            to download immediately after conversion.
          </p>
        </div>
      </section>
